<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-white fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            target="_blank">
            <!-- <span class="font-weight-bold text-lg">KeuMas Al Muwahhidin</span> -->
            <img src="{{ asset('assets/img/logoo.png') }}" class="navbar-brand-img h-100" alt="main_logo">
            <span class="font-weight-bold text-sm ms-2">KeuMas Al Muwahhidin</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('newdashboard') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('transaksi.index') ? 'active' : '' }} " href="{{ route('transaksi.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('transaksi.index') ? 'active' : '' }}" href="{{ route('transaksi.index') }}">
                    <span class=" nav-link-text ms-1">Riwayat Transaksi</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('kategoriTransaksi.index') ? 'active' : '' }}" href="{{ route('kategoriTransaksi.index') }}">
                    <span class=" nav-link-text ms-1">Kategori Transaksi</span>
                </a>
            </li>
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('kegiatan.index') ? 'active' : '' }}" href="{{ route('kegiatan.index') }}">
                    <span class=" nav-link-text ms-1">Kegiatan Masjid</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('jumat.index') ? 'active' : '' }}" href="{{ route('jumat.index') }}">
                    <span class=" nav-link-text ms-1">Kegiatan Jumat</span>
                </a>
            </li>
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">Daftar Keanggotaan</span>
                </div>
            </li>
            <li class="nav-item border-start my-0 pt-2">
